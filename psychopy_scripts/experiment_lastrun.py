...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v3.2.4), February 15, 2020, at 14:01
...
presentation = visual.TextStim(win=win, ori=0, name='presentation',
...
for thisTrial in trials:
    ...
    presentation.setText(Word.encode('utf-8','ignore'))
